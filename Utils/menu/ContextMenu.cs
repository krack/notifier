...
namespace EcuriesDuLoupWin.utils.menu
{
    public abstract class ContextMenu
    {
        ...
        protected EcuriesDuLoupWin.utils.Registry Create(String directoryKey,String key, String value)
        {
            EcuriesDuLoupWin.utils.Registry registry = new RegistryWindows(directoryKey, key, value);    
            return registry;
        }

        protected EcuriesDuLoupWin.utils.Registry Create(String directoryKey)
        {
            EcuriesDuLoupWin.utils.Registry registry = new RegistryWindows(directoryKey);
            return registry;
        }
